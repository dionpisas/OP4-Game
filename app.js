...
var Game = /** @class */ (function () {
    ...
    Game.prototype.preload = function () {
        ...
        var marsLoader = this.game.load.image("mars", "Assets/Graphics/mars.png");
        var venusLoader = this.game.load.image("venus", "Assets/Graphics/venus.png");
    };
    ...
    Game.prototype.update = function () {
        ...
        var spaceshipBounds = this.spaceshipSprite.getBounds();
        var earthBounds = this.earthSprite.getBounds();
